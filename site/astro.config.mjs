...
const sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "UE Reception", translations: { "zh-CN": "UE 接收" }, link: "/docs/signal-processing/ue-reception/" },
      { label: "Monostatic Sensing", translations: { "zh-CN": "单站感知" }, link: "/docs/signal-processing/monostatic-sensing/" },
      { label: "Bistatic Sensing", translations: { "zh-CN": "双站感知" }, link: "/docs/signal-processing/bistatic-sensing/" },
      { label: "OTA and eRTM Timing", translations: { "zh-CN": "OTA 与 eRTM 时序" }, link: "/docs/signal-processing/ota-ertm-timing/" },
    ],
  },
  {
